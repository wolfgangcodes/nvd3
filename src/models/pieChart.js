nv.models.pieChart = function() {
  ...
  d3.rebind(chart, pie, 'valueFormat', 'values', 'x', 'y', 'description', 'id', 'showLabels', 'donutLabelsOutside', 'pieLabelsOutside', 'donut', 'donutRatio', 'labelThreshold', 'donutHoleLabel', 'showDonutHoleLabel');
